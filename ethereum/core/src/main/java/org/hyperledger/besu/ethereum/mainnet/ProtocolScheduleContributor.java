 ...
 * built. Because the entries are config-parametric, a contributor returns nothing for chains it does
 * not target.
 */
@FunctionalInterface
public interface ProtocolScheduleContributor {
  ...
  /**
   * Returns the fork entries this contributor adds for the given chain, in declared order (the order
   * is significant when several modifiers from this contributor share an activation).
   *
