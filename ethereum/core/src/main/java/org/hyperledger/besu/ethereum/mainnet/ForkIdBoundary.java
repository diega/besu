 ...
 * fork-ID boundary: the DAO-recovery sub-milestones ({@code daoBlock + 1}, {@code daoBlock + 10})
 * and a terminal-total-difficulty Merge are spec changes that are deliberately not folded into the
 * fork ID.
 */
