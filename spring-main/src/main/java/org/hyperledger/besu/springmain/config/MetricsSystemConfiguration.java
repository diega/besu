...
public class MetricsSystemConfiguration {
  ...
  @Bean
  public ObservableMetricsSystem metricsSystem(final MetricsConfiguration metricsConfiguration) {
    return MetricsSystemFactory.create(metricsConfiguration);
  }

  @Bean
  public MetricsConfiguration metricsConfiguration(
      final MetricsProtocol metricsProtocol,
  ...
  @Bean
  public MetricsProtocol metricsProtocol(final MetricsProperties metricsProperties) {
