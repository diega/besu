...
public class NatServiceConfiguration {
  ...
  @Bean
  public NatService natService(final Optional<NatManager> manager, final NatOptions natOptions) {
  ...
  @Bean
  public Optional<NatManager> natManager(
      ...
      case DOCKER:
        return Optional.of(
            new DockerNatManager(
                p2pProperties.getHost(), p2pProperties.getPort(), jsonRpcConfiguration.getPort()));
      case NONE:
      default:
