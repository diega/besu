...
public class SynchronizerConfiguration {
  ...
  public Synchronizer synchronizer(
      ...
      final org.hyperledger.besu.ethereum.eth.sync.SynchronizerConfiguration syncConfig,
      final BesuConfiguration besuConfig,
      final StorageProvider storageProvider,
      final Clock clock,
      final MetricsSystem metricsSystem,
      final SyncTerminationCondition fullSyncTerminationCondition) {
  ...
  @Bean
  public SyncTerminationCondition fullSyncTerminationCondition(
      final GenesisConfigOptions genesisConfigOptions, final MutableBlockchain blockchain) {
