...
public class BlockchainConfiguration {
  ...
  @Bean
  public MutableBlockchain blockchain(
  ...
  BlockchainStorage blockchainStorage(
      final StorageProvider storageProvider, final ProtocolSchedule protocolSchedule) {
                ...
                .orElseThrow(
                    () ->
                        new StorageException(
                            "No KeyValueStorageFactory found for key: "
                                + besuProperties.getKeyValueStorageName())))
  ...
  @Bean
  BesuConfiguration besuConfiguration(final BesuProperties besuProperties) {
  ...
  @Bean
  StorageService storageService(final RocksDBCLIOptions options) {
    ...
    RocksDBKeyValuePrivacyStorageFactory privacyFactory =
        new RocksDBKeyValuePrivacyStorageFactory(factory);
  ...
  @Bean
  public GenesisState genesisState(
      final GenesisConfigFile genesisConfig, final ProtocolSchedule protocolSchedule) {
  ...
  protected ProtocolSchedule createProtocolSchedule(
      final GenesisConfigOptions genesisConfigFile,
    ...
    return MainnetProtocolSchedule.fromConfig(
        genesisConfigFile,
        privacyParameters,
        besuProperties.isRevertReasonEnabled(),
        evmConfiguration);
  }

  @Bean
  GenesisConfigOptions genesisConfigOptions(final GenesisConfigFile genesisConfigFile) {
  ...
  @Bean
  public WorldStateStorage worldStateStorage(
      final StorageProvider storageProvider,
      final DataStorageConfiguration dataStorageConfiguration) {
